...
#SBATCH -o {os.path.join(root, "evaluation", exp_root_name,exp_name,"run_files","logs","qsub_out",f"{filename}.log")}
#SBATCH -e {os.path.join(root, "evaluation",exp_root_name,exp_name,"run_files","logs","qsub_err",f"{filename}.log")}
#SBATCH --nodes=1
#SBATCH --ntasks=1
