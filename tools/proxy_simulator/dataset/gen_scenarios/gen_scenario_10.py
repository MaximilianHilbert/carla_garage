"""
Geneates trigger locations for scenario 4.
"""
...
FUNC_SCENARIO_TYPE = {"s10": generate_scenario_10}
...
def town_scenario_tp_gen(town_, carla_map, scen_type, save_dir, world):
    ...
    with open(os.path.join(scen_save_dir, f"{town_}_{scen_type}.json"), "w", encoding="utf-8") as f:
