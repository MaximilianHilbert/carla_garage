...
python $WORK_DIR/train_nocrash_baselines.py \
 --bev 1 --detectboxes 1 --backbone resnet --augment 1 --rear-cam 0 \
 --baseline-folder-names bcso --batch-sizes 18 --datarep 1 \
 --velocity-brake-prediction 1 --train-local 0 --tf_pp_rep 0 --experiment-id datarep1-id6 \
 --cluster galvani
