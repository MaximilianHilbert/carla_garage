...
python $WORK_DIR/train_nocrash_baselines.py --repetitions 1 --seeds 10214 --baseline-folder-names arp bcso bcoh keyframes --use-disk-cache 1 --batch-sizes 5 5 5 5 --walltimes 100 100 100 100 --train-local 0 --dataset-repetition 3 --setting 02_withheld
