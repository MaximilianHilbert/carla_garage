...
python $WORK_DIR/train_nocrash_baselines.py --repetitions 1 --seeds 1014 --baseline_folder_names arp bcoh bcso --number_of_cpus 72 --use-disk-cache 0 --batch-sizes 15 20 25 --walltimes 23 20 12 --train-local 0 --dataset-repetition 3