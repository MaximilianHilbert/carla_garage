...
python $WORK_DIR/train_nocrash_baselines.py --repetitions 1 --seeds 1014 --baseline-folder-names arp bcoh bcso --number-of-cpus 64 --use-disk-cache 0 --batch-sizes 15 15 25 --walltimes 23 20 12 --train-local 0 --dataset-repetition 3 --setting all
