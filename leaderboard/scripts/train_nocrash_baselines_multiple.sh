...
python $WORK_DIR/train_nocrash_baselines.py --ablations speed backbone td prevnum --repetitions 3 --seeds 10214 43534 53543 --baseline-folder-names arp bcso bcoh keyframes --use-disk-cache 0 --batch-sizes 10 25 20 20 --walltimes 100 100 100 100 --train-local 0 --dataset-repetition 3 --setting 02_withheld
