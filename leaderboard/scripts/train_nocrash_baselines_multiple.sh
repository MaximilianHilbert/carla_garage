...
python $WORK_DIR/train_nocrash_baselines.py --repetitions 3 \
 ...
 --baseline-folder-names bcso bcoh --batch-sizes 5 2 \
 --walltimes 72 72 --pretrained 1 --subsampling 1 --velocity-brake-prediction 1 --ego-velocity-prediction 1 --train-local 0 --eval-id id_000 \
 --cluster galvani
