...
python $WORK_DIR/train_nocrash_baselines.py --ablations speed backbone td prevnum --repetitions 3 --seeds 10214 43534 53543 --baseline-folder-names arp bcso bcoh --use-disk-cache 0 --batch-sizes 10 25 20 --walltimes 72 72 72 --train-local 0 --dataset-repetition 3 --setting 02_withheld
