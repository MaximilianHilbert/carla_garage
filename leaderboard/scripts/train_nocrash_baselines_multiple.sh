...
python $WORK_DIR/train_nocrash_baselines.py --repetitions 1 --seeds 10214 --baseline-folder-names arp bcso bcoh keyframes --use-disk-cache 1 --batch-sizes 3 3 3 3 --walltimes 72 72 72 72 --train-local 0 --dataset-repetition 3 --setting 02_withheld --cluster galvani
