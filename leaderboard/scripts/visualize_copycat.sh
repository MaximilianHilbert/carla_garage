...
python $WORK_DIR/tools/visualize_copycat.py --visualize-copycat 1 --number-of-workers 12 --pred-tuning-parameter 0.5 --loss-tuning-parameter 0.5 --baselines bcso bcoh arp