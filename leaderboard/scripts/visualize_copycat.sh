...
python $WORK_DIR/tools/visualize_copycat.py --visualize-copycat 1 --number-of-workers 12 --pred-tuning-parameter 0.15 --gt-tuning-parameter 1 --baselines bcso bcoh arp