...
python $WORK_DIR/tools/visualize_copycat.py --visualize-without-rgb 0 --visualize-combined 1 --number-of-workers 12 --pred-tuning-parameter 0.6 --tuning-parameter_2 0.5 --second-cc-condition gt --baselines bcso bcoh arp --experiments bcso_nospeed_data_rep_3 bcoh_nospeed_data_rep_3 arp_nospeed_data_rep_3