...
def create_scenarios(world, town_data, tmap, scenarios, debug):
    ...
    for scenario_data in town_data:
        ...
        for i in range(len(scenario_list)):
            ...
            world.debug.draw_point(scenario_location + debug_loc_height, float(0.15), color)
            ...
            world.debug.draw_point(new_location + debug_loc_height, float(0.15), carla.Color(0, 0, 0))
            world.debug.draw_string(
            ...
            if debug:
                ...
                spectator.set_transform(carla.Transform(new_location + carla.Location(z=50), carla.Rotation(pitch=-90)))
                input(
