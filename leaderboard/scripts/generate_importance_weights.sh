...
python $WORK_DIR/keyframes/get_importance_weights_training.py --seeds 111 --training-repetition 0 --baseline-folder-name keyframes --baseline-name keyframes_vanilla_weights --number-of-workers 25 --neurons 300 --batch-size 512
