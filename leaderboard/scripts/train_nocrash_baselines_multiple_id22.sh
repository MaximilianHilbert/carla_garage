...
python $WORK_DIR/train_nocrash_baselines.py \
 --bev 1 --detectboxes 1 --backbone resnet --augment 1 --rear-cam 0 --speed 0 \
 --baseline-folder-names bcso --batch-sizes 18 \
 --velocity-brake-prediction 0 --train-local 0 --tf_pp_rep 1 --predict_vectors 0 --experiment-id bcso_single_step_id22 \
 --cluster galvani
