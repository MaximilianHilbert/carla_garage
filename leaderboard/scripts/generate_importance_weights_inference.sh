...
python $WORK_DIR/keyframes/get_importance_weights_inference.py --use-case copycat --training-repetition 0 --baseline-folder-name keyframes --experiment keyframes_weights --number-of-workers 12 --setting 02_withheld
