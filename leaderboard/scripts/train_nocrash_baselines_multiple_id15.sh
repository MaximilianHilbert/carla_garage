...
python $WORK_DIR/train_nocrash_baselines.py \
 --bev 0 --detectboxes 0 --backbone resnet --augment 0 --rear-cam 0 --lossweights 0.5 0.5 --speed 0 \
 --baseline-folder-names bcso bcoh arp --batch-sizes 18 13 13 \
 --velocity-brake-prediction 0 --train-local 0 --tf_pp_rep 1 --experiment-id wp_only_noaug_id15 \
 --cluster galvani
