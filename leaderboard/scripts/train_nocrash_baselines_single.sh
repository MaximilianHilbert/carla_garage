...
torchrun --nnodes=1 --nproc_per_node=8 --rdzv_id=100 --rdzv_backend=c10d $TEAM_CODE/coil_train.py --seed 1 --baseline-folder-name bcso --number-of-workers 8 --training-repetition 0 --use-disk-cache 1 --batch-size 3 --setting 02_withheld --dataset-repetition 3
