...
python $WORK_DIR/train_nocrash_baselines.py \
 --bev 1 --detectboxes 1 --backbone resnet --augment 0 --rear-cam 0 --speed 0 \
 --baseline-folder-names keyframes --batch-sizes 13 \
 --velocity-brake-prediction 0 --train-local 0 --tf_pp_rep 1 --experiment-id keyframes_id16_no_augment \
 --cluster galvani
