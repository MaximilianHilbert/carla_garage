...
python $WORK_DIR/train_nocrash_baselines.py \
 --bev 1 --detectboxes 1 --backbone resnet --augment 0 --rear-cam 0 --speed 1 \
 --baseline-folder-names bcso bcoh arp --batch-sizes 18 13 13 \
 --velocity-brake-prediction 1 --train-local 0 --tf_pp_rep 1 --experiment-id speed_true_new_rep_new_aug_id3 \
 --cluster galvani
